...
public final class DscopePersistenceFactory {
    ...
    static Properties buildAuditPersistenceProperties(Properties effective) {
        ...
        overridden |= copyIfPresent(effective, audit, "agent.audit.jdbc.username", "camel.persistence.jdbc.username");
        overridden |= copyIfPresent(effective, audit, "agent.audit.jdbc.password", "camel.persistence.jdbc.password");
        overridden |= copyIfPresent(effective, audit, "agent.audit.jdbc.driver-class-name", "camel.persistence.jdbc.driver-class-name");
        overridden |= copyIfPresent(effective, audit, "agent.audit.jdbc.driverClassName", "camel.persistence.jdbc.driverClassName");
        overridden |= copyIfPresent(effective, audit, "agent.audit.backend", "camel.persistence.backend");
    ...
    private static boolean copyIfPresent(Properties source, Properties target, String sourceKey, String targetKey) {
